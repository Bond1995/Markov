...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument('--eval_freq', default=500, type=int) # in iterations
    ...
    parser.add_argument('--no_compile', default=True, type=lambda x: (str(x).lower() == 'true')) # if true then model is not compiled 
    # logging params (WandB)
    parser.add_argument('--wandb', default=True, type=lambda x: (str(x).lower() == 'true')) # whether to use wandb or not
