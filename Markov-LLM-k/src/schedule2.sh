...
USER=bondasch
LAB=linx
WANDB_PROJECT="markov-LLM-lowrank"
...
do
    ...
    do
        for init in base;
        do
            #for init_value in 0.1 1 10 100;
            for init_value in 1;
            do
                for j in 1 2 3 4 5;
                do
                    ...
                    RUN_FILE="python main.py --wandb --wandb_project $WANDB_PROJECT --p $p --q $q --init $init --init_value $init_value"
