...
do
    ...
    #for q in 0.3;
    do
        #for sequence_length in 4096 2048 1024 512 256 128 64 32 16 8;
        for initial in steady;
        ...
        do
            ...
            do
                ...
                RUN_FILE="python main.py --wandb --wandb_project $WANDB_PROJECT --p $p --q $q --no_tying"
