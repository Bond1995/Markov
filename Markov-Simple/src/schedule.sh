...
USER=bondasch
LAB=linx
WANDB_PROJECT="markov-simple-init-energy"
    ...
    do
        ...
        do
            ...
            do
                ...
                RUN_FILE="python main.py --wandb --wandb_project $WANDB_PROJECT --p $p --q $q --init $init --iterations 5000"
