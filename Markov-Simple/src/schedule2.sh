...
USER=bondasch
LAB=mlo
WANDB_PROJECT="markov-simple-lowrank-test"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    RUN_FILE="python main.py --wandb --wandb_project $WANDB_PROJECT --p $p --q $q --init $init --v_std $v_std"
