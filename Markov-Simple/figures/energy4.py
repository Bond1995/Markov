...
for h in df1:
    energy1t = h["train/c_fc_energy1"].values[:]
    energy2t = h["train/c_fc_energy2"].values[:]
    energy3t = h["train/c_fc_energy3"].values[:]
    energy4t = h["train/c_fc_energy4"].values[:]
...
fig.savefig("energy2-states.pdf", bbox_inches='tight')
